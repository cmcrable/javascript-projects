...
//3) reverse the first array, and sort the second. What is the difference between these two methods? <<Reverse changes the order of the array elements to last-to-first;
// Sort changes the elements to ascending order according to number, letter case, and alphabetical order.>> Do the methods alter the original arrays? <<YES>>
